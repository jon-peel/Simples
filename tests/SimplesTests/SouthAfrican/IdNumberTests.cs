...
namespace SimplesTests.SouthAfrican
{
    public class IdNumberTests
    {
        ...
        {
            IdNumber id = myId;
            var expectedDate = new DateTime(1984, 01, 29);
            var dateOfBirth = id.DateOfBirth;
            Assert.Equal(expectedDate, dateOfBirth);
        }
        ...
        [InlineData("5309280385089", "1953-09-27T22:00:00.000Z", true, true)]
        [InlineData("6410170770080", "1964-10-16T22:00:00.000Z", true, true)]
        [InlineData("8412065666082", "1984-12-05T22:00:00.000Z", true, true)]
        [InlineData("7103060835084", "1971-03-05T22:00:00.000Z", true, true)]
        [InlineData("8302180857080", "1983-02-17T22:00:00.000Z", true, true)]
        [InlineData("5411270786084", "1954-11-26T22:00:00.000Z", true, true)]
        [InlineData("6212252193086", "1962-12-24T22:00:00.000Z", true, true)]
        [InlineData("8101270160086", "1981-01-26T22:00:00.000Z", true, true)]
        [InlineData("7202156107083", "1972-02-14T22:00:00.000Z", true, true)]
        [InlineData("1010270108085", "2010-10-26T22:00:00.000Z", true, true)]
        [InlineData("4812295009181", "1948-12-28T22:00:00.000Z", true, false)]
        [InlineData("7009110689084", "1970-09-10T22:00:00.000Z", false, true)]
        [InlineData("5503035365087", "1955-03-02T22:00:00.000Z", false, true)]
        [InlineData("7005025451081", "1970-05-01T22:00:00.000Z", false, true)]
        [InlineData("6911240308082", "1969-11-23T22:00:00.000Z", false, true)]
        [InlineData("5201045738084", "1952-01-03T22:00:00.000Z", false, true)]
        [InlineData("6108215079083", "1961-08-20T22:00:00.000Z", false, true)]
        ...
        [InlineData("7207016182184", "1972-06-30T22:00:00.000Z", false, false)]
